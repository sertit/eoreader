...
class S2Product(OpticalProduct):
    ...
    def _manage_invalid_pixels_lt_4_0(
        ...
        nodata_pix.concat(self._open_mask_lt_4_0(S2GmlMasks.DEFECT, band))
        nodata_pix.concat(self._open_mask_lt_4_0(S2GmlMasks.SATURATION, band))
