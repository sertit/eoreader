...
| `UMBRA`                             | GEC                                                                                                                                                             | ✅                    |
| `UMBRA`                             | SICD, SIDD, CPHD, NITF, CSI                                                                                                                                     | ❌                    |
| `UMBRA`                             | SLC                                                                                                                                                             | ❌ (waiting for SNAP) |
...
| **Umbra**              | Pixel size and Resolution                                          |
|------------------------|--------------------------------------------------------------------|
| Spotlight [SP]         | **pixel size: 0.25 to 1.0 m**<br>rg x az resolution: 0.25 to 1.0 m |                                                                                  |
